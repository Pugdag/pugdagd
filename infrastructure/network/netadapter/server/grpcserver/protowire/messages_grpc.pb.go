...
type P2P_MessageStreamClient interface {
	Send(*PugdagdMessage) error
	Recv() (*PugdagdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *PugdagdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*PugdagdMessage, error) {
	m := new(PugdagdMessage)
...
func (x *p2PMessageStreamServer) Send(m *PugdagdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*PugdagdMessage, error) {
	m := new(PugdagdMessage)
...
func (x *rPCMessageStreamClient) Send(m *PugdagdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*PugdagdMessage, error) {
	m := new(PugdagdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *PugdagdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*PugdagdMessage, error) {
	m := new(PugdagdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}

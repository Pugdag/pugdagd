...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether pugdagd thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when pugdagd is not synced.
	// That is because when pugdagd isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this pugdagd initiated the connection
	...
	// The timestamp of when this peer connected to this pugdagd

...
func (x *PugdagdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "PugdagdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *PugdagdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {

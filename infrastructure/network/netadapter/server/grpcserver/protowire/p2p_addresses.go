...
func (x *PugdagdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "PugdagdMessage_Addresses is nil")
	}
...
func (x *PugdagdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {

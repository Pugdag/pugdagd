...
func (x *PugdagdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "PugdagdMessage_Version is nil")
	}
...
func (x *PugdagdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {

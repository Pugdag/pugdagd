...
func (x *PugdagdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "PugdagdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *PugdagdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {

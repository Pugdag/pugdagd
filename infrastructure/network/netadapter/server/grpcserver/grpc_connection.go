...
type grpcStream interface {
	Send(*protowire.PugdagdMessage) error
	Recv() (*protowire.PugdagdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.PugdagdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.PugdagdMessage) error {

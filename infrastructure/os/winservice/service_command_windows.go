...
// installService attempts to install the pugdagd service. Typically this should
...
// removeService attempts to uninstall the pugdagd service. Typically this should
...
// startService attempts to Start the pugdagd service.

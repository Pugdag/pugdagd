...
import (
	...
	"github.com/pugdag/pugdagd/util/network"
...
const (
	defaultConfigFilename      = "pugdagd.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "pugdagd.log"
	defaultErrLogFilename      = "pugdagd_err.log"
	...
	sampleConfigFilename    = "sample-pugdagd.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for pugdagd.
	DefaultAppDir = util.AppDir("pugdagd", false)
...
// Flags defines the configuration options for pugdagd.
//
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 26590, testnet: 16211)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 26589, testnet: 16210)"`
...
// Config defines the configuration options for pugdagd.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default pugdagd configuration
...
//
// The above results in pugdagd functioning properly without any config settings
...
// createDefaultConfig copies the file sample-pugdagd.conf to the given destination path,

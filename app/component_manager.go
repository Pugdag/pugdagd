...
// Start launches all the pugdagd services.
...
// Stop gracefully shuts down all the pugdagd services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Pugdagd is already in the process of shutting down")
		return
	}

	log.Warnf("Pugdagd shutting down")

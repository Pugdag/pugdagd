...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := pugdagd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = pugdagd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = pugdagd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
